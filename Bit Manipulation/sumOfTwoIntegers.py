...
Integers have fixed length (32 bits) in java. So carry (or b) will eventually 
be moved out of boundary and go to 0, 
and you can get out of the while loop. This is NOT the case for the Python! 
Python allows unlimited length of integers. 
2. By setting up a mask 0xFFFFFFFF. & this mask with an (very long) 
integer will only keep the last 32 bits.
